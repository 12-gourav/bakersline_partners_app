        ...
        <View style={ProfileStyles.container}>
          ...
          <View style={ProfileStyles.info}>
            ...
            <View style={ProfileStyles.form}>
             ...
             <View style={ProfileStyles.info}>
            <Text style={ProfileStyles.infoHead}>Shop Information</Text>
            <View style={ProfileStyles.form}>
              <View style={ProfileStyles.form_icon}>
                <Fontisto name="shopping-store"  size={16} color={pink}/>
                <Text>Name</Text>
              </View>

              <Text style={ProfileStyles.pText}>{user?.shop?.shopName}</Text>
            </View>
            <View style={ProfileStyles.form}>
              <View style={ProfileStyles.form_icon}>
                <Feather name="phone" size={16} color={pink} />
              ...
              <Text style={ProfileStyles.pText}>{user?.shop?.shopAddress}, {user?.shop?.shopZipCode} </Text>
            </View>
