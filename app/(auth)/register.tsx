...
const Register = () => {
  ...
  const handleRegister = async () => {
    try {
      ...
      if (shopZip === "") {
        return Alert.alert(
          "Missing Shop Address Zip",
          "Please enter your shop address zip code.",
          [{ text: "OK" }]
        );
      }
      if (origin?.length === 0) {
      ...
      myForm.append("shopAddress", shopAddress);
      myForm.append("shopZip", shopZip);
    ...
    <SafeAreaView style={{ flex: 1 }}>
      ...
      >
        <View style={AuthStyles.wrapper}>
          ...
          <View style={AuthStyles.formGroup}>
            <Text style={AuthStyles.label}>Shop Address</Text>
            <TextInput
              style={AuthStyles.input}
          ...
          <View style={AuthStyles.formGroup}>
            <Text style={AuthStyles.label}>Shop Address Zip Code</Text>
            <TextInput
              style={AuthStyles.input}
